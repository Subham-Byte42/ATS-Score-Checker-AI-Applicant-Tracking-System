    ...
    <div className="bg-white rounded-3xl border border-slate-200/90 shadow-2xs overflow-hidden space-y-0">
      ...
      <div className="p-6 bg-slate-900 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="w-12 h-12 rounded-2xl bg-slate-800 border border-slate-700 text-teal-400 flex items-center justify-center shrink-0 shadow-xs">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 bg-slate-800 text-teal-300 font-extrabold text-xs rounded-full border border-slate-700">
                Gemini 3.6 Flash
              </span>
            </div>
        ...
        <button
          ...
          disabled={loading}
          className="px-4 py-2 bg-slate-800 hover:bg-slate-700 active:scale-95 text-white font-bold text-xs rounded-xl border border-slate-700 flex items-center gap-2 transition-all cursor-pointer disabled:opacity-50 shrink-0"
        >
      ...
      {loading && (
        <div className="p-8 bg-white">
          <BrandedLoadingScreen 
            ...
            inline={true}
            size="sm"
            message="Consulting Gemini AI Career Advisor..."
            subMessage="Analyzing resume gaps, tech stack requirements, and generating targeted interview & career tips"
          />
        </div>
      )}
