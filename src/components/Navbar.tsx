  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
        <div className="w-full max-w-[2200px] mx-auto px-4 sm:px-8 lg:px-14">
          <div className="flex items-center justify-between h-20">
            ...
            >
              <div className="w-11 h-11 rounded-xl bg-[#1877f2] flex items-center justify-center text-white shadow-md shadow-blue-500/20 group-hover:scale-105 transition-transform">
              ...
              <nav className="hidden md:flex items-center gap-10">
                {navItems.map((item) => (
                  <button
                    ...
                    className={`text-base font-semibold transition-all cursor-pointer border-b-2 py-1.5 ${
              ...
              {user ? (
                ...
                <div className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className="w-11 h-11 rounded-full bg-[#1877f2] hover:bg-[#0866ff] text-white flex items-center justify-center font-bold text-lg shadow-md shadow-blue-500/20 active:scale-95 transition-all cursor-pointer ring-2 ring-blue-100 focus:outline-none relative overflow-hidden"
                  ...
                  {/* Dropdown Menu */}
                  {isDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-60 rounded-2xl bg-white border border-slate-200/90 shadow-2xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                      ...
                      <div className="py-1">
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-[#1877f2] transition-colors cursor-pointer text-left"
                        >
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-between px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-[#1877f2] transition-colors cursor-pointer text-left"
                        >
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 text-slate-700 hover:text-[#1877f2] hover:bg-slate-100 font-semibold text-base rounded-xl transition-all cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 bg-slate-900 text-white hover:bg-slate-800 font-semibold text-base rounded-xl transition-all cursor-pointer shadow-sm"
                  >
