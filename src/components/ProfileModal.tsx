        ...
        <div className="px-6 pb-6 relative">
          ...
          <div className="-mt-12 mb-5 flex justify-between items-end">
            <div className="relative group">
              <div className="w-20 h-20 rounded-2xl bg-slate-900 text-teal-400 flex items-center justify-center text-3xl font-extrabold shadow-md ring-4 ring-white overflow-hidden">
                {profilePic ? (
              ...
              <button
                ...
                className="absolute -bottom-1 -right-1 p-2 bg-slate-900 hover:bg-slate-800 text-teal-400 rounded-xl shadow-md ring-2 ring-white transition-all cursor-pointer group-hover:scale-105"
            ...
            <div className="flex flex-col items-end gap-1">
              <button
                onClick={() => fileInputRef.current?.click()}
                className="text-xs font-semibold text-slate-900 hover:underline flex items-center gap-1 cursor-pointer bg-slate-100 px-2.5 py-1 rounded-lg"
              >
